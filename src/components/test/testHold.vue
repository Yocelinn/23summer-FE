        ...
        <el-container>
            ...
            <el-container>
                ...
                <div>
                    ...
                    <div class="edit_container" style="width: 700px;left:420px; top:100px"  @keyup="handkeKeyUp" @keydown="handleKeyDown">
                        <QuillEditor id="editorId" ref="myQuillEditor" :content="editorContent" contentType="html"
                                     @updateContent="update" :options="options" style="width: 100%;left:420px; top:160px; height: 800px"  />
                    </div>
                    <div class="templateuse">
                        <el-card class="templatecard" style="position: absolute;height:650px;width:200px;top:100px;background-color: rgba(255, 255, 255, 0.85);left:1140px" >
                            <div>
                                <div slot="header" class="clearfix">
                                    <h3>文档模板</h3>
                                </div>
