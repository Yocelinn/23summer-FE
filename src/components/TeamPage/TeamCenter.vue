...
import ManageTeam from "@/components/TeamPage/ManageTeam/ManageTeam.vue";
import ChooseTeam from "@/components/TeamPage/ChooseTeam/ChooseTeam.vue";

export default defineComponent({
    name: "TeamCenter",
    components: {ChooseTeam, ManageTeam},
    setup() {
