      ...
      <div class="botoom">
        ...
        <div class="chatInputs">
          <div class="emoji boxinput" @click="clickEmoji">
            ...
            <!-- /Users/liuyanwen/23summer-FE/src/assets/img/emoji/face-vomiting.png -->
          </div>
    ...
    .botoom {
      ...
      .chatInputs {
        ...
        .send {
          ...
          border: 0;
          transition: 0.3s;
          box-shadow: 0px 0px 5px 0px rgba(0, 136, 255,0.5);
          &:hover {
            box-shadow: 0px 0px 10px 0px rgba(0, 136, 255,0.5);
          }
        }
      }
    }
