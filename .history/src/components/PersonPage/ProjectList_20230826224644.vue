...
// 未完成                            curProjectId.value = response.data.id;
        ...
        const handleDelete = (index, data) => {
            axios.post('http://81.70.184.77:8000/project/delete', {
...
<<<<<<<< HEAD:src/components/PersonPage/ProjectList/ProjectList.vue
            axios.post('http://81.70.184.77:8000/project/info', {
========
            axios.post('/project/info', {
>>>>>>>> main:.history/src/components/PersonPage/ProjectList_20230826224644.vue
                team_id: curTeamId.value
            }, {
                headers: { Authorization: user.token }
            })
