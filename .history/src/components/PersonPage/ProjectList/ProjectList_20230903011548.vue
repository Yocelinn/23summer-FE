<template>
    ...
    <div class="table-container-pl">
        <el-table class="table-pl" :data="projectData" style="width: 100%" stripe="true" fit="true">
            ...
            <el-table-column style="color:#9E9CF4;">
                <template #header >
                    <div style="color: #9E9CF4; align-items: center">
                        操作
                    </div>
                </template>
                <template #default="scope">
...
/*.access-pl:active {*/
/*    border: hidden;*/
/*    background-color: rgba(161, 235, 222, 0.34);*/
/*    color: rgba(161, 235, 222, 0.37);*/
/*}*/
/*.access-pl:hover,*/
/*.access-pl:focus {*/
/*    border: hidden;*/
/*    background-color: rgba(161, 235, 222, 0.26);*/
/*    color: #81BBDE;*/
/*}*/
...
.delete:active {
    border: hidden;
    background-color: rgba(250, 204, 204, 0.34);
    color: rgba(250, 204, 204, 0.52);
}
.delete:hover,
.delete:focus {
    border: hidden;
    background-color: rgba(250, 204, 204, 0.26);
    color: #DAACCC;
}
